...
const SubscriptionBreakdown = ({ data = [], loading = false }) => {
  ...
  return (
    <div className="bg-white dark:bg-card rounded-lg p-6 border border-gray-200 dark:border-border shadow-sm">
      ...
      {/* Summary Stats */}
      <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-gray-200 dark:border-border">
        <div>
          <p className="text-xs text-gray-600 dark:text-muted-foreground mb-1">Total Active</p>
        ...
        <div>
          <p className="text-xs text-gray-600 dark:text-muted-foreground mb-1">MRR</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-foreground">
          ...
          return (
            <div key={plan.name} className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-foreground min-w-[80px] text-right">

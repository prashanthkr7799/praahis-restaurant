...
import { fromRestaurant } from '@config/supabase';
import { formatCurrency } from '@shared/utils/formatters';
import { CardSkeleton, ChartSkeleton } from '@shared/components/feedback/LoadingSkeleton';
import RevenueChart from '@features/manager/components/analytics/RevenueChart';
import OrdersChart from '@features/manager/components/analytics/OrdersChart';
import StatusChart from '@features/manager/components/analytics/StatusChart';
import PopularItemsChart from '@features/manager/components/analytics/PopularItemsChart';
